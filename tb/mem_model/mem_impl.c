...
void write_memory(const int address, const svBitVecVal* data, const svBit write_en) {
    if (!write_en) {
...
void read_memory(const int address, svBitVecVal* data, const svBit read_en) {
    if (!read_en) {
